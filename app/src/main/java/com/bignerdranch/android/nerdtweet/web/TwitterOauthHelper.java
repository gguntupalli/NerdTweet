...
public class TwitterOauthHelper {
    ...
    private static final String CONSUMER_KEY = "AVY5OiLwI2yWREDhMq1ROdbOF";
    private static final String CONSUMER_SECRET = "A16CUMxXQtSoWUX2GRjwtwolAFkGOOjOMZxiEDEctlZsTBHJdN";
